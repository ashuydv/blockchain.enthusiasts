                    ...
                    <Link href='/resources'>
                        <div className="flex flex-wrap w-full bg-[#242424] py-32 px-10 relative mb-4 rounded-3xl overflow-hidden">
                            <div className="text-center relative z-10 w-full">
                                ...
                                <p class="leading-relaxed text-gray-200">Discover a curated list of blockchain resources, from the basics to roadmap generators, and more.</p>
                            </div>
                            ...
                            <Link href='/projects'>
                                <div className="flex flex-wrap w-full bg-[#242424] sm:py-24 py-16 sm:px-10 px-6 relative rounded-3xl overflow-hidden">
                                    <div className="text-center relative z-10 w-full">
                                        ...
                                        <p class="leading-relaxed text-gray-200">Explore a curated list of blockchain projects, ranging from foundational concepts to advanced developments.</p>
                                    </div>
